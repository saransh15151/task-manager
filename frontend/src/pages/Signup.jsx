        ...
        <div className="auth-form-side">
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            <div className="form-group">
              <label htmlFor="signup-name"><span className="required">*</span> Full Name</label>
            ...
            <div className="form-group">
              <label htmlFor="signup-email"><span className="required">*</span> Email</label>
              <div className="input-container">
                <input
                  id="signup-email"
                  type="email"
            ...
            <div className="form-group">
              <label htmlFor="signup-password"><span className="required">*</span> Password</label>
              <div className="input-container">
                <input
                  id="signup-password"
